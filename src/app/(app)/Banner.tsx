...
const WETTBEWERB = '\u{1F4F8} Foto-Wettbewerb läuft! Lade dein schönstes Rikscha-Foto hoch und stimme jetzt ab — Galerie aufrufen!';
...
export default function Banner() {
  ...
  const separator = '   ·   ';
  const alleTexte = texte.length > 0 ? [...texte, WETTBEWERB] : [WETTBEWERB];
  const lauftext  = alleTexte.join(separator) + separator;
