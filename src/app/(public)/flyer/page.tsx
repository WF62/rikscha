        ...
        <div className="sheet">
          ...
          <div className="panel p1 v1">
            ...
            <div className="voucher-body">
              ...
              <div className="voucher-side">
                <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789223970539-so0gizrnjv.png" alt="Logo" style={{width:52,height:52,borderRadius:'50%',objectFit:'cover',alignSelf:'center',marginBottom:'0.3rem'}}/>
          ...
          <div className="panel p4 v4">
            <div className="cover-row">
              <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789223970539-so0gizrnjv.png" alt="Mertener Rikschakutscher Logo" style={{width:52,height:52,borderRadius:'50%',objectFit:'cover',flexShrink:0}}/>
              <div>
