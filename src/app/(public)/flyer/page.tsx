        ...
        <div className="sheet">
          ...
          <div className="panel p1 v1">
            ...
            <div className="voucher-body">
              ...
              <div className="voucher-side">
                <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789229186303-8k7xwb5hcdd.png" alt="Logo" style={{width:52,height:52,alignSelf:'center',marginBottom:'0.3rem',mixBlendMode:'darken'}}/>
          ...
          <div className="panel p4 v4">
            <div className="cover-row">
              <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789229186303-8k7xwb5hcdd.png" alt="Mertener Rikschakutscher Logo" style={{width:52,height:52,flexShrink:0,mixBlendMode:'darken'}}/>
              <div>
