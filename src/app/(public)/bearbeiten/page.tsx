...
const WEBSITE_BEZEICHNUNGEN: Record<string, string> = {
  ...
  stimme_4_text:     'Stimme 4 – Zitat (leer = ausgeblendet)',
  stimme_4_name:     'Stimme 4 – Name',
  stimme_4_rolle:    'Stimme 4 – Rolle (Gast / Pilot)',
  stimme_5_text:     'Stimme 5 – Zitat (leer = ausgeblendet)',
  stimme_5_name:     'Stimme 5 – Name',
  stimme_5_rolle:    'Stimme 5 – Rolle (Gast / Pilot)',
  stimme_6_text:     'Stimme 6 – Zitat (leer = ausgeblendet)',
  stimme_6_name:     'Stimme 6 – Name',
  stimme_6_rolle:    'Stimme 6 – Rolle (Gast / Pilot)',
