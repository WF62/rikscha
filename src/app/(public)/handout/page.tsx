...
const LOGO = 'https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789229186303-8k7xwb5hcdd.png';
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo { width:44px; height:44px; flex-shrink:0; mix-blend-mode:multiply;filter:contrast(8) brightness(0.9); }
