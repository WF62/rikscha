...
const LOGO = 'https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789230103391-2hv16dhd6k6.png';
    ...
    <>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo { width:44px; height:44px; flex-shrink:0; border-radius:50%; background:rgba(255,255,255,0.18); padding:4px; object-fit:contain; }
