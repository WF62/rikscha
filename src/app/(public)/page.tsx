    ...
    <>
      ...
      <nav aria-label="Hauptnavigation">
        <a href="/" className="nav-logo" aria-label="Mertener Rikschakutscher – Startseite">
          ...
          <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789230837654-o3j4ecfxsw.png" alt="" aria-hidden="true" width={48} height={48} style={{flexShrink:0,borderRadius:'50%',background:'rgba(255,255,255,0.18)',padding:'6px',objectFit:'contain'}} />
      ...
      <section className="hero">
        <div className="container">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789230837654-o3j4ecfxsw.png" alt="Mertener Rikschakutscher Logo" style={{width:160,height:160,margin:'0 auto 1.5rem',display:'block',borderRadius:'50%',background:'rgba(255,255,255,0.18)',padding:'20px',objectFit:'contain'}} />
