    ...
    <>
      ...
      <nav aria-label="Hauptnavigation">
        <a href="/" className="nav-logo" aria-label="Mertener Rikschakutscher – Startseite">
          ...
          <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789228954115-7l3rj3vat29.png" alt="" aria-hidden="true" width={40} height={40} style={{flexShrink:0,borderRadius:'50%',background:'rgba(255,255,255,0.18)',padding:'4px'}} />
      ...
      <section className="hero">
        <div className="container">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="https://hcbqmqyxpasojbrewnps.supabase.co/storage/v1/object/public/piloten-dateien/1789228954115-7l3rj3vat29.png" alt="Mertener Rikschakutscher Logo" style={{width:140,height:140,margin:'0 auto 1.5rem',display:'block',borderRadius:'50%',background:'rgba(255,255,255,0.18)',padding:'12px',objectFit:'contain'}} />
